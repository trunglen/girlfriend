...
import chat.girlfriend.findgirlfriend.ui.DetailImageAdapter
import chat.girlfriend.findgirlfriend.ui.GirlInfoActivity
import chat.girlfriend.findgirlfriend.ui.VideoGirl
import chat.girlfriend.findgirlfriend.utils.GIRL_STORAGE
import chat.girlfriend.findgirlfriend.utils.existGirl
import chat.girlfriend.findgirlfriend.utils.getLocalStorage
import chat.girlfriend.findgirlfriend.utils.putLocalStorage
...
//        val adapter = DetailListViewAdapter(this, girlGallery as ArrayList<String>)
        ...
        tvAlert.setOnClickListener {
            Toast.makeText(this,"Thank you! We will process information about "+girl.name,Toast.LENGTH_LONG).show()
        }
        requestAds(banner)
    }
